...
<head>
  ...
  <title>Web Trend - We're available for marketing</title>
...
<body id="top">
    ...
    <div class="container">
      ...
      <nav class="navbar container" data-navbar>
        <ul class="navbar-list">
          ...
          <li>
            <a href="#project" class="navbar-link" data-nav-link>Products</a>
          </li>
          ...
          <li>
            <a href="#blog" class="navbar-link" data-nav-link>Acount</a>
          </li>
      ...
      <section class="section about" id="about" aria-label="about">
        <div class="container">
          ...
          <div class="about-banner img-holder" style="--width: 720; --height: 960;">
            <img src="assets/images/product000.jpg" width="720" height="960" loading="lazy" alt="about banner"
              class="img-cover">
  ...
  <footer class="footer">
    <div class="container">
      ...
      <p class="copyright">
        &copy; 2022 All Rights Reserved by <a href="#" class="copyright-link">Web Trend</a>
      </p>
